...
public class BookView2 extends JPanel {
	...
	public void initView() {
		...
		JScrollPane scroll = new JScrollPane(table);  //데이터 많아지면 스크롤바 생김
	...
	//DefaultTableModel에 도시정보들을 설정한다.
	public void putResult() {
		...
		for(int i = 0; i<bookVOList.size(); i++) {
			...
			model.setValueAt(vo.getAuther(), i, 3);
	...
	public BookVO neededInsertData() {
		...
		vo.setAuther(tf[3].getText());
		vo.setPrice(tf[4].getText());
